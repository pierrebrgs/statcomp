...
describe_discvar= function(x) { #to define a discrete var, it requires a single value/function
...
describe_var= function(x, vartype) { #takes 2 arguments
...
```{r}
describe_var(fandango$rt_norm, vartype='continuous') #fandango$rt_norm means the var rt_norm in fandango
```
...
```{r, error=TRUE}
fun= function(x, y=0, ...) { #... means there might be more variable 
  return(sum(x, ...) + sum(y, ...))
}
